...
class AppDialogGenderWidget extends StatefulWidget {
  ...
  const AppDialogGenderWidget({Key? key, this.initialGender, this.onPressCancel, this.onPressSave}) : super(key: key);
        ...
        for (int i = 0; i < AppConstant.listGender.length; i++)
          AppTouchable(
            ...
            child: Row(
              children: [
                Text(
                  chooseContentByLanguage(AppConstant.listGender[i]['nameEN'], AppConstant.listGender[i]['nameVN']),
                ...
                AppConstant.listGender[i]['id'] == _value['id']
                    ...
                    : Container(
                        ...
                        height: 20.0.sp,
                        decoration:
                            BoxDecoration(borderRadius: BorderRadius.circular(12.0.sp), color: const Color(0xFFD9D9D9)),
                      ),
              ],
            ),
          ),
